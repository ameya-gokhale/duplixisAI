...
import { downloadCSV } from "../utils/api.jsx";
  ...
  return (
    <div style={styles.processingCard}>
      <div style={styles.processingInner}>
        ...
        <div>
          <p style={styles.processingTitle}>Running model on your data</p>
      ...
      <div style={styles.stepsList}>
        {[
          "Writing CSV to temp file",
          "Loading dummy.pkl model",
          "Running inference on rows",
